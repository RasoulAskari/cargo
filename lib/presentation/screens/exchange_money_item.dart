              ...
              child: Table(
                ...
                children: [
                  ...
                  cTableCell(
                      ...
                      title: widget.exchange.amount.toString()),
                  cTableCell(
                      label: AppLocalizations.of(context)!.currency,
                      title: widget.exchange.currency),
                  cTableCell(
                      label: AppLocalizations.of(context)!.exchange_money_id,
                      title: widget.exchange.exchnageId),
                  cTableCell(
                      label: AppLocalizations.of(context)!.phone_num,
                      title: widget.exchange.phoneNumber),
                  cTableCell(
                      label: AppLocalizations.of(context)!.receiver_id,
                      title: widget.exchange.receiverIdNo.toString()),
                 cTableCell(
                      label: AppLocalizations.of(context)!.receiver_name,
                      title: widget.exchange.receiverName),
