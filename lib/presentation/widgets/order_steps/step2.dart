    ...
    return Padding(
      ...
      child: Column(
        children: [
          ...
          InputLabel(label: AppLocalizations.of(context)!.reciver_type),
          BlocBuilder<OrderCubit, OrderState>(
            builder: (context, state) {
              return CTextField(
          ...
          InputLabel(label: AppLocalizations.of(context)!.country),
          BlocBuilder<OrderCubit, OrderState>(
            builder: (context, state) {
              return CTextField(
          ...
          InputLabel(label: AppLocalizations.of(context)!.city),
          BlocBuilder<OrderCubit, OrderState>(
            builder: (context, state) {
              return CTextField(
          ...
          InputLabel(label: AppLocalizations.of(context)!.address),
          BlocBuilder<OrderCubit, OrderState>(
            builder: (context, state) {
              return CTextField(
